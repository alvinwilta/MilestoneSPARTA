    ...
    render(){
        ...
        return(
                <View style={styles.videoBox}>
                    <Image source={{uri: video.thumbnail}} style={{width:108, height:60, marginLeft:10}}/>
                    <View style={{flex:1, marginLeft:10}}> 
                        <TouchableOpacity>
                            <Text numberOfLines={2}
                                style={{fontFamily:'Roboto', fontSize:16, fontWeight:"normal",color:"#000000", flexWrap:"wrap"}}
                                onPress={() => {Linking.openURL(url)}}>{video.title}</Text>
                        </TouchableOpacity>
                        <Text style={{fontFamily:'Roboto', fontSize:11, fontWeight:"normal",color:"#7E8485"}}>{video.time}</Text>
                    </View>
                </View>
        )
    }
